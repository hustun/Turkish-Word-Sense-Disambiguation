# -*- coding: utf-8 -*-
"""
Created on Sat Apr 25 02:18:40 2020
...
# api-endpoint 
URL = "https://www.hurriyet.com.tr/sitemaps/posts.xml"
...
i=0
postsFile = open('posts12.txt', "w", encoding="utf-8")
for link in links:
    print(f'Link {i}')
    print(link)
    ...
    while target1 in response:
        startIndex = response.find(target1) + len(target1) + 9
        endIndex = response.find(target2) - 3
    ...
    for post in posts:
        ...
        if "/yerel-haberler/" in URL:
            ...
            article = soup.find_all("div", class_=re.compile("rhd-all-article-detail"))
